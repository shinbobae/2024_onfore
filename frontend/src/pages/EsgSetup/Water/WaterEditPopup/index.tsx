...
const WaterEditPopup = ({ isOpen, mode, onClose, columnData }: WaterEditPopupProps) => {
  ...
  return (
    <EditPopup
      isOpen={isOpen}
      title={mode === 'add' ? '물 정수량 항목 추가' : '물 정수량 정보 수정'}
      description="물 정수량 항목에 대한 계산 방법을 입력해주세요."
      onClose={onClose}
